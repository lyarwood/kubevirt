...
func (_m *MockVirtApiAuthorizor) CreateSubjectAccessReview(_param0 *v1.SubjectAccessReview) (*v1.SubjectAccessReview, error) {
	ret := _m.ctrl.Call(_m, "CreateSubjectAccessReview", _param0)
	ret0, _ := ret[0].(*v1.SubjectAccessReview)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

func (_mr *_MockVirtApiAuthorizorRecorder) CreateSubjectAccessReview(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCall(_mr.mock, "CreateSubjectAccessReview", arg0)
}
