...
type MockInstancetypeMethods struct {
	...
	FindInstancetypeResourceAttributesFunc func(vm *v1.VirtualMachine, verb string) (*authv1.ResourceAttributes, error)
	...
	FindPreferenceResourceAttributesFunc   func(vm *v1.VirtualMachine, verb string) (*authv1.ResourceAttributes, error)
...
func (m *MockInstancetypeMethods) FindInstancetypeResourceAttributes(vm *v1.VirtualMachine, verb string) (*authv1.ResourceAttributes, error) {
	return m.FindInstancetypeResourceAttributesFunc(vm, verb)
}
...
func (m *MockInstancetypeMethods) FindPreferenceResourceAttributes(vm *v1.VirtualMachine, verb string) (*authv1.ResourceAttributes, error) {
	return m.FindPreferenceResourceAttributesFunc(vm, verb)
}
...
func NewMockInstancetypeMethods() *MockInstancetypeMethods {
	return &MockInstancetypeMethods{
		...
		FindInstancetypeResourceAttributesFunc: func(_ *v1.VirtualMachine, _ string) (*authv1.ResourceAttributes, error) {
			return nil, nil
		},
		...
		FindPreferenceResourceAttributesFunc: func(_ *v1.VirtualMachine, _ string) (*authv1.ResourceAttributes, error) {
			return nil, nil
		},
